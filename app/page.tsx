...
import { BOOKING_HREF } from "@/lib/bokun";
    ...
    <>
          ...
          <div className="hero-copy">
            <div className="inner">
              ...
              <div className="hero-actions">
                <a href={BOOKING_HREF} className="btn btn-gold">
                  Book Now
                </a>
              </div>
            </div>
      ...
      >
        <div className="wrap">
          ...
          <div className="hero-actions">
            <a href={BOOKING_HREF} className="btn btn-book">
              Book Now
            </a>
      ...
      <section className="pad highlights-band">
        <div className="wrap sig-grid">
          <div className="sig-left">
            ...
            <a href={BOOKING_HREF} className="btn btn-wine">
              Book Now
            </a>
          </div>
